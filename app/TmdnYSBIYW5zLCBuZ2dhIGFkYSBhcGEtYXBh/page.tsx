        ...
        <div className="content">
          ...
          <section className="section-content member">
            <p className={raleway.className}>
              ...
              menu one week straight like Nasi Padang or Soto without exchanging
              and re-rollin' it again on the next week, your level of
              consistency its like even stronger than the typescript itself.
              It's good but please also remember you can still try this and that
              alright ? It's like the coffee you sometimes come to me to ask
              scissor to open it, besides water you have coffee.
            </p>
            <p className={raleway.className}>
              Thank you Hans for all the memes you always share it with me,
              we're going through Batu Akik to the Brave Story of Ghazal without
              even know but laugh together. It's like our things to brighten up
              the day after the daily quests has been done isn't it? anyway, we
              all know this is living would like. You grind, you goin' home, but
              you feel wonders from smallest things
            </p>
            <p className={raleway.className}>
              ...
              complainings all the time seeing it, without realizing he was
              using word-themed VS code.
            </p>
            <p className={raleway.className}>
              ...
              same color scheme as Bellinda's have. The thing is, the team were
              most behind the wheels, but we need someone to be on those wheels.
              I'm sorry there's no Yamaha for the models, Yamaha exist but in
              form of Delivery Truck :')
            </p>
          </section>
